...
import { ArrowRight, Wallet, Repeat, Coins } from 'lucide-react';
...
function Button({ children, icon, primary = false }: { children: React.ReactNode; icon?: React.ReactNode; primary?: boolean }) {
  return (
    <button
      className={`
