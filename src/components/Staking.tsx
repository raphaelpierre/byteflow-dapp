...
export default function Staking() {
  ...
  return (
    <section className="min-h-screen bg-black pt-20" id="staking">
...
function StakingFeature({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="relative group">
